...
<p>
  ...
  <b><i>post_commentaire_valide_by_ID.php</i></b> :<br/>
  -> <b>GET</b> id du commentaire<br />
...
<p>
  ...
  -> <b>POST</b> json(auteurId(int), nom(string), ingredients(string), description(string), note(int : 0 à 10), categorieId(int), dateRec(date : date de création), difficulte(string))<br />
  -> <b>RETURN</b> status(int), status_message(string)<br />
</p>
