...
CREATE TABLE `recettes` (
  ...
  `tps_prepa` time NOT NULL,
  `difficulte` enum('debutant','intermediaire','confirme','expert') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
