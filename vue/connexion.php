...
<form method="post"  action="index.php?uc=controleur&action=inscription">
    ...
    <p>
        ...
        <input type = "text"  name = "loginI" size = "20" maxlength = "45" placeholder = "Login">
     </p>
     <p>
        <label for = "mdpI">Mot de passe</label>
        <input type = "password"  name = "mdpI" size = "20" maxlength = "45" placeholder = "Mot de passe">
    </p>
    <p>
        <label for = "nom">Nom</label>
        <input type = "text"  name = "nom" size = "30" maxlength = "45" placeholder = "Nom de famille">
    </p>
    <p>
        <label for = "prenom">Prenom</label>
        <input type = "text"  name = "prenom" size = "25" maxlength = "45" placeholder = "Prenom">
    </p>
    <input type = "submit" value = "Valider" name = "valider">
    <input type = "reset" value = "Annuler" name = "annuler"> 
</form>